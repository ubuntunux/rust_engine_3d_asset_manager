...
class UnityAssetParser(AssetParser):
    ...
    def process_asset_data(cls, asset_metadata):
        match(asset_metadata.get_asset_type()):
            ...
            case AssetTypes.MODEL:
                ...
                asset_metadata.set_data(AssetTypes.MATERIAL_INSTANCE, cls.process_material_instances(yaml_data))
    ...
    def process_material_instances(cls, yaml_data):
        ...
        if 'MeshRenderer' in yaml_data:
            ...
            __logger__.error(msg)
            raise ValueError(msg)
        return [__asset_descriptor_manager__.get_asset_metadata_by_guid(AssetTypes.MATERIAL_INSTANCE, guid=guid).get_asset_path() for guid in material_guids]
    ...
    def process_mesh(cls, yaml_data):
        if 'MeshFilter' in yaml_data:
            ...
            __logger__.error(msg)
            raise ValueError(msg)
        return __asset_descriptor_manager__.get_asset_metadata_by_guid(AssetTypes.MESH, guid=mesh_guid).get_asset_path()
